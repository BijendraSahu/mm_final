    ...
    <div class="container">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3"><label for=""><b>Rs. {{$totalCost}}&nbsp;({{$amt}} + {{$amt_pum}})</b></label>
                    <input type="hidden" readonly="readonly" class="form-control" name="amount"
                           value="{{$totalCost}}" id="amtall" placeholder="Enter Amount">
                </div>
                ...
                <div class="col-sm-3"><label for=""><b>{{str_replace(' ', '', $user->name)}}</b></label>
                    <input type="hidden" readonly="readonly" value="{{str_replace(' ', '', $user->name)}}"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3"><label for=""><b>{{$mobile}}</b></label>
                    <input type="hidden" readonly="readonly" name="phone"
                           value="{{$mobile}}" class="form-control" id="phone"
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="col-sm-3"><label for=""><b>{{"Rs. ".$plan->amount."(".$plan->plan_name.")"}}</b></label>
                </div>
            </div>
        </div>
