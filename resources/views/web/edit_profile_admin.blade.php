                                    ...
                                    <div class="col-sm-6">
                                        <div class="textbox_containner">
                                            <input type="text" name="contact" autocomplete="off" class="animate_txt"
                                                   id="contact" placeholder="9589883533" value="{{$user->contact}}"/>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="textbox_containner">
                                            <input type="text" editable="false" name="mob" autocomplete="off"
                                                   class="animate_txt" id="mob" placeholder="Enter Primary Number"
                                                   value="{{$user->mob}}">
                                            <label class="animate_placeholder" for="mob">Primary Number</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="textbox_containner">
                                            <input type="text" editable="false" name="mob2" autocomplete="off"
                                                   ...
                                                   value="{{$user->mob2}}">
                                            <label class="animate_placeholder" for="mob2">Alternate Number</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="update_profile_row row">
