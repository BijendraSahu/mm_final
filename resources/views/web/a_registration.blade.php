                    ...
                    <div class="form_allcontainer">
                        ...
                        <fieldset style="display: block;">
                                ...
                                <div class="col-sm-6">
                                    <div class="textbox_containner">
                                        <input type="text" editable="false" name="name" autocomplete="off"
                                               class="animate_txt required" id="name"
                            ...
                            <div class="row form-group">
                                <div class="col-sm-6">
                                    <div class="textbox_containner">
                                        ...
                                        <label class="animate_placeholder" for="contact">Contact No<span
                                                    class="rq_color">*</span></label>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="row form-group">
                                <div class="col-sm-6">
                                    <div class="textbox_containner">
                                        <input type="text" editable="false" name="password" autocomplete="off"
                        ...
                        <fieldset style="display: none;">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select name="caste" class="form-control requiredDD txt_wizard"
                                            id="caste">
