...
$(".addmore").on('click', function () {
    ...
    html += '<td><input type="text" name="quantity[]" id="quantity_' + i + '" class="form-control changesNo value-change pqty required numberOnly" placeholder="Quantity" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';

    html += '<td><input type="text" name="itemRate[]" id="itemRate_' + i + '" class="form-control required changesNo" placeholder="Rate" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"></td>';
